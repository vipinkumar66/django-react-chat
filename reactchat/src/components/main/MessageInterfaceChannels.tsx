...
const MessageInterfaceChannels = (props:ServerChannelProps) => {
    ...
    data?.find((server)=> server.id === Number(serverId))
  ...
  return (
    ...
    position="sticky"
    elevation={0}>
        <Toolbar variant="dense" sx={{minHeight:theme.primaryAppBar.height,
        height:theme.primaryAppBar.height, display:"flex", alignItems:"center"}} >
